...
const ShippingForm: React.FC<ShippingFormProps> = ({
	...
	// Handle division change and update the corresponding district options
	...
	// Handle district change and update the corresponding sub-district options
	...
	const handleAddressSelection = (
		...
		setFieldValue("division", selectedAddress.division);
		setFieldValue("district", selectedAddress.district);
	...
	useEffect(() => {
		if (!isOrderConfirm && cart.items.length === 0) {
			router.push("/");
		}
	}, [cart, isOrderConfirm, router]);
